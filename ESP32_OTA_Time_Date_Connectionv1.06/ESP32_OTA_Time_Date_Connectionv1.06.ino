...
char* device = "Clock";
char* model = "ClockDev01ESP32";
char* ver = "v1.0";
char* fw = "v1.06.005119";
char* fwname = "ESP32_OTA_Time_Date_Connectionv1.06";
...
{ ArduinoOTA.handle();
  ...
  display.setFont(ArialMT_Plain_16); display.drawString(0, 45, String (WiFi.RSSI()));
...
//*****************************************************************************************
void config_wire() {
  Wire.begin(4, 15);               // (sda,scl) Start the Wire service for the OLED display using pin=22 for SCL and Pin-21 for SDA on ESP32 Dev1 board.
...
void Start_SSD1306_Setup() {
  ...
  display.drawString(0, 15, "Wayne Sowka");
  display.setFont(ArialMT_Plain_10);
  display.drawString(0, 30, model);
  display.drawString(0, 40, fwname);
  display.drawString(0, 50, SerialNo);
  display.display();
}
//*****************************************************************************************
