...
char* device = "Clock";
char* model = "ClockESP32";
char* ver = "v1.0";
char* fw = "v1.04.140919";
char* fwname = "ESP32_OTA_Time_Date_Connectionv1.04";
...
void setup() {
  ...
  Start_SSD1306_Setup();
  StartWiFi();
  WiFi.softAP("ESP_Clock", "password");
  Start_Time_Services();
...
{ ArduinoOTA.handle();
  ...
  display.setFont(ArialMT_Plain_16); display.drawString(45, 45, String (WiFi.RSSI()));
